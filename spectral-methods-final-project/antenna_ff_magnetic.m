...
xlabel('\theta [deg]');
ylabel('|E| / |E_{max}| [dB]');
title('Radiation Pattern @ m_{y} = 1, \phi = 0 deg, R = 1 m');
saveas(gcf, 'figures\rad_pattern\em_phi_0deg.fig');
...
xlabel('\theta [deg]');
ylabel('|E| / |E_{max}| [dB]');
title('Radiation Pattern @ m_{y} = 1, \phi = 45 deg, R = 1 m');
saveas(gcf, 'figures\rad_pattern\em_phi_45deg.fig');
...
xlabel('\theta [deg]');
ylabel('|E| / |E_{max}| [dB]');
title('Radiation Pattern @ m_{y} = 1, \phi = 90 deg, R = 1 m');
saveas(gcf, 'figures\rad_pattern\em_phi_90deg.fig');
